 ...
 *         launched.
 * @param  arg: The sole argument of the start_routine to be provided.
 * @retval int: 0 on success and nonzero error number on error.
 */
 ...
 * @param  None
 * @retval pthread_t: The thread ID.
 */
...
/**
 * @brief  Initialize the mutex attribute object with default values
...
/**
 * @brief  Destroy the mutex attribute object
...
/**
 * @brief  Initialize the mutex with specified attributes
...
/**
 * @brief  Lock the mutex. If the mutex object referenced by mutex is
...
/**
 * @brief  Destroy the attribute object of the conditional variable
 ...
 * @param  cond: The conditional variable to signal the state change.
 * @retval int: 0 on success and nonzero error number on error.
 */
 ...
 *         be signaled
 * @param  cond: The conditional variable object for waiting the state change.
 * @retval int: 0 on success and nonzero error number on error.
 */
